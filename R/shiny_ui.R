    ...
    sidebarLayout(
      ...
      mainPanel(
        tabsetPanel(
          ...
          # outputDataTable is broken in shiny 1.4.0, a fix will be in the next version
          # in the meantime use DT::outputDataTable instead of outputDataTable
          # https://github.com/rstudio/shiny/issues/2653
          tabPanel("Estimates", DT::dataTableOutput("estimates")),
